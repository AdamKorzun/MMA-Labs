...
def solve_task1(e=0.001):
    ...
    while cur_precision > e:
        ...
        iter_count += 1
        print('Итерация: {}, Точность: {}, Начальный шаг: {}'.format(iter_count, cur_precision, h))
...
def solve_task2(e=0.04):
    ...
    while cur_precision > e:
        ...
        cur_precision = np.max(np.abs([y1[2 * i] - y[i] for i in range(len(y))]))
        iter_count += 1
        print('Итерация: {}, Точность: {}, Текущий шаг: {}'.format(iter_count, cur_precision, h))
